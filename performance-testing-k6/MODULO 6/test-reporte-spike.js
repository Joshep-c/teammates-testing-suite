...
export const options = {
  stages: [
    { duration: "30s", target: 10 },   // Carga inicial baja
    { duration: "15s", target: 300 },  // Incremento repentino (Spike)
    { duration: "1m", target: 300 },   // Mantener carga alta brevemente
    { duration: "15s", target: 10 },   // Descenso brusco
    { duration: "1m", target: 10 },    // Recuperación estable
    { duration: "30s", target: 0 },    // Finalizar prueba
  ],
};
