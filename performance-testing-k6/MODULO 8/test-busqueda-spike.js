...
export const options = {
  stages: [
    { target: 10, duration: '10s' },   // Inicio gradual
    { target: 100, duration: '10s' },  // Spike rápido
    { target: 100, duration: '30s' },  // Carga sostenida alta
    { target: 10, duration: '10s' },   // Descenso abrupto
    { target: 0, duration: '10s' },    // Finalización
  ],
};
